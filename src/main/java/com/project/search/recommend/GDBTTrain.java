...
public class GDBTTrain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //load data
        JavaRDD<String> csvFile = sparkSession.read().textFile("file:///Users/fanyujia/Desktop/data/feature.csv").toJavaRDD();
        ...
        gbtClassificationModel.save("file:///Users/fanyujia/Desktop/data/gbdtmode");
